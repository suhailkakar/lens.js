...
Let's be honest, creating a social media app from scratch is a bit of a challenge. You need to setup a database, a server, and a client and much more. Just like other social media apps, you need to create a user, post, and comment system. You would also need to manage the scalibitly, CDN.
